...
<div class="container">
    <div class="card card-border-warning mb-2" style="max-width: 100rem; margin-top: 1rem">
        <div class="card-header text-center text-white" style="background-color: #000000;">Ver titulo</div>
        <div class="card-body">
              ...
              <div class="form-group" >
                ...
                <div class="row>
                    <div class="form-group" align="center">
                        <a href="{{url('titulos')}}" title="Cancelar y regresar" class="btn btn-dark">ATRAS</a>
                    </div>
                </div>
              </form>
            </div>
